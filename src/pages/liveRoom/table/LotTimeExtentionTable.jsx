...
function LotTimeExtentionTable({
  singleAuctionData,
      ...
      >
        <thead>
          <tr>
            ...
            <th>Quantity / UOM</th>
            <th>
              {singleAuctionData?.auctionType === "reverseAuction"
                ? "Max Decrement(Rs.)"
                : "Min Increment(Rs.)"}
            </th>
          </tr>
        ...
        <tbody>
          {singleAuctionData?.offers?.map((items) => (
            <tr key={items?._id}>
              ...
              <td>
                {" "}
                {items?.scrapDetails?.quantity}/{items?.scrapDetails?.unit}
              </td>
              <td>
                {singleAuctionData?.auctionType === "reverseAuction"
                  ? items?.maximumBid
...
export default LotTimeExtentionTable;

...
import ProductLiveLotDetails from "../children/ProductLiveLotDetails";
import ProductAuctionTimeExtention from "../children/ProductAuctionTimeExtention";

function ProductLiveRoomForLots() {
  ...
  return (
    <div className="flex column gap-10px">
      ...
      >
        <ProductAuctionTimeExtention
          singleAuctionData={liveRoomSingleAuctionData?.auction}
          singleAuctionLoading={liveRoomSingleAuctionLoading}
          offers={liveRoomSingleAuctionData?.offers}
        />
      </Modal>
      <Modal
        actions={[]}
...
export default ProductLiveRoomForLots;
// import
...
import ProductTimeExtentionTable from "../table/ProductTimeExtentionTable";

function ProductAuctionTimeExtention({ singleAuctionData, singleAuctionLoading, offers }) {
...
export default ProductAuctionTimeExtention;

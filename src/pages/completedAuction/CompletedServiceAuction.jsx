...
import ServiceAuctionDateAndTime from "../singleOrganization/buyer/AuctionDetail/components/ServiceAuctionDateAndTime";

function CompletedServiceAuction() {
          ...
          <button
            ...
            onClick={() => {
              if (singleAuctionData?.reschedule?.status) {
                ...
                navigate(
                  `/reverse-service-auction/reschedule-auction/${singleAuctionData?.industry}/${singleAuctionData?._id}`
                );
              } else {
...
export default CompletedServiceAuction;

...
import ProductAuctionDateAndTime from "../singleOrganization/buyer/AuctionDetail/components/ProductAuctionDateAndTime";

function CompletedProductAuction() {
          ...
          <button
            ...
            onClick={() => {
              if (singleAuctionData?.reschedule?.status) {
                ...
                navigate(
                  `/reverse-product-auction/reschedule-auction/${singleAuctionData?.industry}/${singleAuctionData?._id}`
                );
              } else {
...
export default CompletedProductAuction;
